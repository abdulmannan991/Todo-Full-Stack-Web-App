...
/**
 * Login Page for Midnight Genesis
 *
 * Structure created by @ui-auth-expert (T024)
 * Validation implemented by @ui-auth-expert (T025)
 * Better Auth integration by @ui-auth-expert (T026)
 * Premium Midnight styling by @css-animation-expert (T027)
 */
...
export default function LoginPage() {
  ...
  // T026: Better Auth login integration
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showErrorToast(error.message || 'Invalid email or password. Please try again.')
      setErrors({
      ...
      <main className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm sm:text-base text-text-secondary">
            Sign in to your Midnight Genesis account
          </p>
        </div>
